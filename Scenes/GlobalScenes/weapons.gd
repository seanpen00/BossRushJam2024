...
# BULLET
var BULLET_PROJECTILE : PackedScene = preload("res://Scenes/Player/Weapons/Bullet/bullet.tscn")
...
# PEBBLE
var PEBBLE_PROJECTILE : PackedScene = preload("res://Scenes/Player/Weapons/Pebble/pebble.tscn")
